...
for m = soft
eval(['node' num2str(m) ' = node' num2str(m) ' -1 + (1+1)*rand(1,1200);' ]);
end
...
tempT = [tempT; eval(['node' num2str(i) '_prev'])'];   %%%SOFT
...
csvwrite('C:\Users\AGONZALEZVID\Desktop\Work_melb\actual\BMECode\Results_Dockland\softPMF12.csv',[cluster; time; RMSE_final]) 
