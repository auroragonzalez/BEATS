...
nsmax = n
tic
predict_temprature_BME3 = BMEintervalMode3(ck,ch3,cs2,temp,a,b,modelCsand,paramsand,nhmax,nsmax,dmax,order);time(n) = toc
...
%csvwrite('C:\Users\AGONZALEZVID\fig15NA10pNSchangesNH3SOFT.csv', [nh',MAPE', RMSE', CVRMSE', time'])