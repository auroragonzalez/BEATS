...
nhmax = 6;
tic
predict_temprature_BME4 = BMEintervalMode4(ck,ch3,cs2,temp,a,b,modelCsand,paramsand,nhmax,nsmax,dmax,order);time(n) = toc
...
%csvwrite('C:\Users\AGONZALEZVID\fig14NAchangesNH6SOFTx.csv', [ns',MAPE, RMSE, CVRMSE, time])
%csvwrite('fig14NAchangesNH6SOFTx.csv', [ns',MAPE, RMSE, CVRMSE, time])