...
csvwrite('C:\Users\AGONZALEZVID\Desktop\Work_melb\actual\BMECode\Results_Dockland23\nodes.csv',  [node_506_humidity_measured' node_509_humidity_measured' node_510_humidity_measured' node_511_humidity_measured'])
...
eval(['node' num2str(m) '= node_' num2str(nodes(m)) '_humidity_measured(1:Nn);' ]);
end
...
%   fprintf(1, 'epoch %4i batch %4i Training RMSE %6.4f  Test RMSE %6.4f RMSE Final %6.4f   \n', ...
%             epoch, batch, err_train(epoch), err_valid(epoch), RMSE);
...
csvwrite('C:\Users\AGONZALEZVID\Desktop\Work_melb\actual\BMECode\Results_Dockland23\hardPMF2.csv', [RMSEx time])
