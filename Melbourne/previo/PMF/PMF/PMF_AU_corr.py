...
#        print "K : ", k, " Index: ", index, " Data amount: ", data.shape
        if (data.shape[1]> 1): # cuando haya más de una columna en el grupo (más de un sensor claro)
            ...
            pd.DataFrame(np.transpose([[k]*len(sensRep),sensRep, trreal, trpred])).to_csv('/home/aurora/Git_repos/posgradoActual/Melbourne/BMECode/metrics/predandRealPMF2.csv', index=False,mode='a')
